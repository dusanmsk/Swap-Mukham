...
#{'input_type': 'Video', 'image_path': None, 'video_path': '/home/msk/encfs/faceswap/projects/test1/src-short.webm', 'directory_path': '',
# 'output_path': '/home/msk/encfs/faceswap/Swap-Mukham-dusanmsk', 'output_name': 'Result', 'keep_output_sequence': False, 
# 'mask_includes': ['Skin', 'R-Eyebrow', 'L-Eyebrow', 'L-Eye', 'R-Eye', 'Nose', 'Mouth', 'L-Lip', 'U-Lip'],
#  'mask_soft_kernel': 17.0, 'mask_soft_iterations': 7.0, 
# 'ui_after': <function process.<locals>.ui_after at 0x7f2a284d7a30>, 
# 'ui_after_vid': <function process.<locals>.ui_after_vid at 0x7f2a284d7ac0>,
#  'start_time': 1689885081.1676946, 
# 'get_finsh_text': <function process.<locals>.<lambda> at 0x7f2a284d7be0>, 
# 'age': 25.0, 
# 'blur_amount': 20.0, 
# 'condition': 'All Face', 
# 'crop_bott': 0.0,
...
#  'face_scale': 1,
#  'source_path': '/tmp/gradio/2d7eac48545a36abdad0cf1c93965c88ed494264/image.png',
#  'specifics': (None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None),
#  'total_exec_time': <function process.<locals>.<lambda> at 0x7f2a284d7b50>,
#  'ui_before': <function process.<locals>.ui_before at 0x7f2a2862e830>}
